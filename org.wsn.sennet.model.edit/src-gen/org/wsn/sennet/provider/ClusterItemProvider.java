...
/**
 * This is the item provider adapter for a {@link org.wsn.sennet.Cluster} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClusterItemProvider extends IdentifiableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cluster_resources_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cluster_resources_feature", "_UI_Cluster_type"),
				 SennetPackage.Literals.CLUSTER__RESOURCES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SennetPackage.Literals.CLUSTER__NODES);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Cluster_type") + " " + cluster.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.CLUSTER__NODES,
