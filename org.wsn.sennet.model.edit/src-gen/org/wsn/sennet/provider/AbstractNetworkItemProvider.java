...
/**
 * This is the item provider adapter for a {@link org.wsn.sennet.AbstractNetwork} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractNetworkItemProvider extends IdentifiableItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SennetPackage.Literals.ABSTRACT_NETWORK__NB_OF_NODES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SennetPackage.Literals.ABSTRACT_NETWORK__INTER_NODE_COMM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SennetPackage.Literals.ABSTRACT_NETWORK__ROUTING_PROTOCOL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES);
			childrenFeatures.add(SennetPackage.Literals.ABSTRACT_NETWORK__SINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createAccelerometerSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createLightSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createLocationSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createMicrophoneSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createTemperatureSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createPressureSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createHumiditySensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__RESOURCES,
				 SennetFactory.eINSTANCE.createVoltageSensor()));

		newChildDescriptors.add
			(createChildParameter
				(SennetPackage.Literals.ABSTRACT_NETWORK__SINK,
