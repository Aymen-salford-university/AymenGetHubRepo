 ...
 * <ul>
 *   <li>{@link org.wsn.sennet.impl.IdentifiableImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiableImpl extends MinimalEObjectImpl.Container implements Identifiable {
	...
	protected EClass eStaticClass() {
		return SennetPackage.Literals.IDENTIFIABLE;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SennetPackage.IDENTIFIABLE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SennetPackage.IDENTIFIABLE__ID:
				return getId();
		}
