 ...
 * <ul>
 *   <li>{@link org.wsn.sennet.impl.AbstractNodeImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.wsn.sennet.impl.AbstractNodeImpl#getNodeResources <em>Node Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractNodeImpl extends IdentifiableImpl implements AbstractNode {
	...
	protected EClass eStaticClass() {
		return SennetPackage.Literals.ABSTRACT_NODE;
	}
	...
	public void setPosition(Position newPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SennetPackage.ABSTRACT_NODE__POSITION, oldPosition, position));
	}
	...
	public EList<AbstractSensor> getNodeResources() {
		if (nodeResources == null) {
			nodeResources = new EObjectContainmentEList<AbstractSensor>(AbstractSensor.class, this, SennetPackage.ABSTRACT_NODE__NODE_RESOURCES);
		}
